    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void addBook()
        {
            try
            {
                ...
                //System.Diagnostics.Debug.WriteLine(DropDownList3.SelectedItem.Text);

                cmd.Parameters.AddWithValue("@book_id", TextBox1.Text.Trim());
                cmd.Parameters.AddWithValue("@book_name", TextBox2.Text.Trim());
                cmd.Parameters.AddWithValue("@genre", genres);
                cmd.Parameters.AddWithValue("@author_name", DropDownList3.SelectedItem.Value.ToString().Trim());
                cmd.Parameters.AddWithValue("@publisher_name", DropDownList2.SelectedValue.ToString());
                cmd.Parameters.AddWithValue("@publish_date", TextBox3.Text.Trim());
                cmd.Parameters.AddWithValue("@language", DropDownList1.SelectedItem.Value);
                cmd.Parameters.AddWithValue("@edition", TextBox9.Text.Trim());
                cmd.Parameters.AddWithValue("@book_cost", TextBox10.Text.Trim());
        ...
        void addAuthorPublisherinDropDown()
        {
            try
            {
                SqlConnection con = new SqlConnection(strcon);
