               ...
               <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col-2 mx-auto">
                             ...
                             <asp:Button ID="Button1" class="btn btn-lg btn-block btn-primary" runat="server" Text="Clear Form" OnClick="Button1_Click" />
      
                        
                     </div>
                     <div class="col-8 mx-auto">
                 
                             <asp:Button ID="Button2" class="btn btn-lg w-100 btn-block btn-danger" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
